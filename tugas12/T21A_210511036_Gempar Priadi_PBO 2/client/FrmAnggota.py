...
class FrmAnggota:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Prodi:').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='No_Telp:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        ...
        self.txtNo_telp.grid(row=4, column=1, padx=5, pady=5)
        # Textbox
    ...
    def TampilkanData(self, event=None):
        ...
        self.txtNo_telp.delete(0,END)
        self.txtNo_telp.insert(END,obj.no_tlp)
        self.txtAlamat.delete(0,END)
